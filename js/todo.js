...
$(document).ready(() => {
    if (UrlUtils.getUrlParams().pagina == 'TarefaOld') {
        new OldTodo();
    } else {
        new Todo();
    }
...
class OldFrontend_Page {
}

class OldFrontend_TarefaOld extends OldFrontend_Page {
...
class OldFrontend_Entity {
}

class OldFrontend_Entity_Tarefa extends OldFrontend_Entity {
